...
Data <- readMat("modelXY.mat")
file.remove("modelXY.mat")
Lam1G <- readMat("lam1G.mat")
X.m<-Data$X
Y.m<-Data$Y
...
MSGLassolam1 <- Lam1G$lam1G[1]
MSGLassolamG <- Lam1G$lam1G[2]
...
writeMat("hatTheta.mat", hattheta=try$Beta)
